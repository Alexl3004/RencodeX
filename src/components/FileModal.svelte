...
<style>
  ...
  .metric-val {
    font-family: "Geist Mono", monospace;
    font-size: 13px; font-weight: 700; color: var(--color-text); line-height: 1;
  }
  .metric-label {
  ...
  .metric-div {
    width: 1px; height: 28px; background: var(--color-border); flex-shrink: 0;
  }

  /* Langs */
  .langs-row { display: flex; gap: 12px; }
  .lang-group { flex: 1; display: flex; flex-direction: column; gap: 5px; }
  ...
  .stream-type {
    ...
    color: var(--color-accent); font-weight: 600; min-width: 72px;
  }
